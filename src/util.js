...
const STYLE_CONFLICTS = {
  ...
  marginLeft: new Set(["marginInlineStart", "marginInline"]),
  marginRight: new Set(["marginInlineEnd", "marginInline"]),
  marginTop: new Set(["marginBlockStart", "marginBlock"]),
  marginBottom: new Set(["marginBlockEnd", "marginBlock"]),
  paddingLeft: new Set(["paddingInlineStart", "paddingInline"]),
  paddingRight: new Set(["paddingInlineEnd", "paddingInline"]),
  paddingTop: new Set(["paddingBlockStart", "paddingBlock"]),
  paddingBottom: new Set(["paddingBlockEnd", "paddingBlock"]),
  mask: new Set([
    "maskClip",
    "maskComposite",
    "maskImage",
